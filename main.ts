...
namespace ZETA_R3 {
    ...
    //% group="Send data with query" weight=95 blockGap=8
     ...
     * @param txArray データ配列
     */
    //% blockId=ZETA_data_tx_no_query block="Transmit ZETA data (no response) %txArray"
    //% group="Send data without query" weight=95 blockGap=8
